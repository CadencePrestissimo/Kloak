    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAlarmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent setAlarmIntent = new Intent(MainActivityAlarm.this, SetAlarmActivity.class);
                MainActivityAlarm.this.startActivityForResult(setAlarmIntent, SET_ALARM_INTENET_REQUEST_CODE);
            }
        });
